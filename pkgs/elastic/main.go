...
func main() {
	...
	// on 192.168.20.33:9200. Of course you can configure your client to connect
	// to other hosts and configure it in various other ways.
	client, err := elastic.NewClient(elastic.SetURL("http://192.168.20.33:9200"))
	if err != nil {
		// Handle error
		panic(err)
	}
	...
	info, code, err := client.Ping("http://192.168.20.33:9200").Do(ctx)
	if err != nil {
		// Handle error
		panic(err)
	}
	...
	esversion, err := client.ElasticsearchVersion("http://192.168.20.33:9200")
	if err != nil {
		// Handle error
		panic(err)
	}
	...
	if !exists {
		fmt.Printf("twitter index not exists, creatint it...\n")
